       ...
       def res():
              ...
              if res==1:
                     if e.get()=="rishav":
                            ...
                            mlabel2=Label(top, text="username found!",font="Helvetica, 24")     #this is a new windows so evey argu. will be top not root.
                            mlabel2.pack(pady=50,padx=50)
                            b4=Button(top,text="Continue")                       #this is a new window so evey argu. will be top not root.
                            ...
                            mlabel3=Label(top, text="username not found!",font="Helvetica, 24")     #this is a new windows so evey argu. will be top not root.
                            mlabel3.pack(pady=50,padx=50)
                            b3=Button(top,text="try again",command=top.destroy)                       #this is a new window so evey argu. will be top not root.
                            b3.pack(padx=50,pady=30)
                            
                            
              else:
                     top.destroy()

       b2=Button(top,text="Continue",command=res)                       #this is a new window so evey argu. will be top not root.
