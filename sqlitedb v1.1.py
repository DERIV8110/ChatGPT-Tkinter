...
name_labels=Entry(root,text='enter name').grid(row=0,column=0)
address_labels=Entry(root,text='enter address').grid(row=1,column=0)
phone_labels=Entry(root,text='enter phone').grid(row=2,column=0)
# define submit below
